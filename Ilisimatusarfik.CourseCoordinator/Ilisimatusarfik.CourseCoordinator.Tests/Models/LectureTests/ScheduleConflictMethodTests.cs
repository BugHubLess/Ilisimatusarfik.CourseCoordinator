namespace Ilisimatusarfik.CourseCoordinator.Tests.Models.LectureTests
{
    ...
    public class ScheduleConflictMethodTests
    {
        ...
        [Theory]
        [InlineData(10, 1, 2, 12, 0, 1)]
        [InlineData(9, 59, 3, 11, 59, 1)]
        public void WhenOverlapping_ShouldHaveScheduleConflict(int hour1, int minutes1, int duration1, int hour2, int minutes2, int duration2)
        {
            // Arrange
            var l1 = new Lecture();
            var l2 = new Lecture();
